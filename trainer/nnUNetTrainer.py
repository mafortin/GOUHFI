...
from trainer.configuration import ANISO_THRESHOLD, default_num_processes
from trainer.evaluation.evaluate_predictions import compute_metrics_on_folder
from trainer.inference.export_prediction import export_prediction_from_logits, resample_and_save
from trainer.inference.predict_from_raw_data import nnUNetPredictor
from trainer.inference.sliding_window_prediction import compute_gaussian
from trainer.paths import nnUNet_preprocessed, nnUNet_results
from trainer.training.data_augmentation.compute_initial_patch_size import get_patch_size
from trainer.training.dataloading.data_loader_2d import nnUNetDataLoader2D
from trainer.training.dataloading.data_loader_3d import nnUNetDataLoader3D
from trainer.training.dataloading.nnunet_dataset import nnUNetDataset
from trainer.training.dataloading.utils import get_case_identifiers, unpack_dataset
from trainer.training.logging.nnunet_logger import nnUNetLogger
from trainer.training.loss.compound_losses import DC_and_CE_loss, DC_and_BCE_loss
from trainer.training.loss.deep_supervision import DeepSupervisionWrapper
from trainer.training.loss.dice import get_tp_fp_fn_tn, MemoryEfficientSoftDiceLoss
from trainer.training.lr_scheduler.polylr import PolyLRScheduler
from trainer.utilities.collate_outputs import collate_outputs
from trainer.utilities.crossval_split import generate_crossval_split
from trainer.utilities.default_n_proc_DA import get_allowed_n_proc_DA
from trainer.utilities.file_path_utilities import check_workers_alive_and_busy
from trainer.utilities.get_network_from_plans import get_network_from_plans
from trainer.utilities.helpers import empty_cache, dummy_context
from trainer.utilities.label_handling.label_handling import convert_labelmap_to_one_hot, determine_num_input_channels
from trainer.utilities.plans_handling.plans_handler import PlansManager
...
class nnUNetTrainer(object):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
        ...
        self.num_epochs = 500 #OG value: 1000
